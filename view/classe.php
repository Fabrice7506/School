        ...
        <table id="myTable" class="display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="modifyclient.php?id=<?php echo $classe['Cod_classe']; ?>" class="btn btn-secondary">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Suppression classe</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="delete.php?id=<?php echo $classe['Cod_classe']; ?>" class="btn btn-danger">Supprimer</a>
                    </div>
                    </div>
                </div>
                </div>
