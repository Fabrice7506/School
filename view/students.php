        ...
        <table id="myTable" class="display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="modifyclient.php?id=<?php echo $infoStudents['Cod_El']; ?>" class="btn btn-secondary">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="delete.php?id=<?php echo $infoStudents['Cod_El']; ?>" class="btn btn-danger">Supprimer</a>
                    </div>
                    </div>
                </div>
                </div>
