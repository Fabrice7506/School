<?php 
 ...
 ?>
    <div class="" style="margin-top: 200px;">
            <a href="add_students.php" class="btn btn-primary" style=" float:right; margin-bottom: 20px;">
        ...
        <table id="myTable" class="display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="modify_students.php?id_students=<?php echo $infoStudents['Cod_El']; ?>" class="btn btn-secondary">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Suppression Elève</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    Voulez vous supprimer ce elève?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <a href="delete.php?id_students=<?php echo $infoStudents['Cod_El']; ?>" class="btn btn-danger">Supprimer</a>
                    </div>
                    </div>
                </div>
                </div>
